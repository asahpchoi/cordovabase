...
var AppComponent = /** @class */ (function () {
    function AppComponent(dialog, ngZone) {
        this.dialog = dialog;
        this.ngZone = ngZone;
    }
    AppComponent.prototype.openDialog = function () {
        ...
        this.ngZone.run(function () {
            var dialogRef = _this.dialog.open(__WEBPACK_IMPORTED_MODULE_2__dialogdemo_dialogdemo_component__["a" /* DialogdemoComponent */], {
                width: '250px',
                data: { name: _this.name, animal: _this.animal }
            });
...
var DialogdemoComponent = /** @class */ (function () {
    function DialogdemoComponent(dialogRef, ngZone) {
        this.dialogRef = dialogRef;
        this.ngZone = ngZone;
    }
    DialogdemoComponent.prototype.close = function () {
        var _this = this;
        this.ngZone.run(function () {
